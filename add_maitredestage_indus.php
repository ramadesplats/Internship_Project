<?php
 if (isset($_POST['submit'])){
    ...
    $idtestlabo = $xml->createElement('idEntrepr');
    $idtestlabo->nodeValue = $_POST['identreprise'];
    ...
    echo '<script>window.alert("no entreprise with this id has been found"); window.location.href = "evaluation.html"; </script>';
    die();
